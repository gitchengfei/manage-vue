    ...
    <el-container class="wrapper">
        ...
        <el-container class="container-box" v-bind:class="{'slide-hide': isCollapse, 'slide-in-left': !isCollapse}">
            ...
            <el-header class="header" height="40px" id="header">
                        ...
                        <el-dropdown trigger="click">
                            ...
                            <el-dropdown-menu slot="dropdown">
                                ...
                                <el-dropdown-item><span
                                    @click="openOrCloseUpdateHeadPortrait = true">{{ headPortraitMenu }}</span>
                                </el-dropdown-item>
                ...
                <!--修改密码-->
                <el-dialog title="修改密码" :visible.sync="passwordFormVisible" :width=" isPc ? '40%' : '90%'"
                           :top=" isPc ? '15vh' : '10vh'">
                ...
                <!-- 修改头像窗口 -->
                <el-dialog :title="headPortraitMenu" :visible.sync="openOrCloseUpdateHeadPortrait"
                           :width="isPc ? '320px' : '80%'"
                           :top=" isPc ? '15vh' : '10vh'">
                    <div align="center">
                        <el-upload
                            ...
                            <img v-if="newHeadPortrait" :src="newHeadPortrait" class="avatar">
                            <i v-else class="el-icon-plus avatar-uploader-icon" style="line-height: 178px"></i>
                        </el-upload>
                        <span v-if="headPortrait">点击图片重新上传</span>
                    </div>
                    <div slot="footer" class="dialog-footer">
                        <el-button @click.native="openOrCloseUpdateHeadPortrait = false">取消</el-button>
                        <el-button type="primary" @click.native="doUpdateHeadPortraitId">确认
                        </el-button>
                    </div>
    ...
    export default {
        data() {
            ...
            return {
                ...
                //修改头像窗口开关
                openOrCloseUpdateHeadPortrait: false,
                //头像
                headPortrait: "",
                //新头像
                newHeadPortrait: "",
        ...
        methods: {
             ...
             * @Author : cheng fei
             * @CreateDate 2019/6/2 1:03
             * @param res
             * @param file
             */
            handleAvatarSuccess(res, file) {
                this.newHeadPortraitId = res.id;
                this.newHeadPortrait = res.path
            },
            /**
             * @Description : 文件上传前设置
             * @Author : cheng fei
             ...
             * @Description : 执行修改头像
             * @Author : cheng fei
             * @CreateDate 2019/6/2 1:20
             */
            doUpdateHeadPortraitId() {
                this.$Http.doPostForForm(
                    this,
                    'account/account/head/portrait',
                    {
                        fileId: this.newHeadPortraitId
                    },
                    function (self, data) {
                        self.headPortrait = data.data;
                        self.$store.commit(self.$Types.RECEIVE_ACCOUNT_INFO_HEAD_PORTRAIT, self.headPortrait);
                        self.openOrCloseUpdateHeadPortrait = false
                    }
                )
            }
        },
